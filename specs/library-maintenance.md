...
Similar-photo analysis derives groups from current image facts and configured similarity criteria, without user-authored exclusions. Prior exclusion records and their backup history remain untouched and inert; they neither suppress grouping nor provide a current editing surface. A change in the grouping rules invalidates the affected derived groups without discarding unrelated indexed information.
